...
\pubdata{\textit{Philosophical Quarterly} 53 (2003): 425-31.} 
...
\item \(x\) is a suman iff \(x\) is a human \(C\) or a Sim who is not a \(C\).
\item \(x\) is a him iff \(x\) is a Sim \(C\) or a human who is not a \(C\).
\end{enumerate}
\item \begin{enumerate}
\item \(x\) is a human iff \(x\) is a suman \(C\) or a him who is not a \(C\).
\item \(x\) is a Sim iff \(x\) is a him \(C\) or a suman who is not a \(C\).
\end{enumerate}
}
...
More generally, we still need a distinction here between the property of being human and the property of being suman that shows why ordinary evidence should be independent of the first property but not the second. One might think the distinction can reside in the fact that \textit{being human} is a natural property, while \textit{being suman} is gruesome. The lesson of Goodman's riddle of induction is that we have to give a privileged position in our epistemic framework to natural properties like \textit{being human}, and this explains the distinction. This response gets the status of privileged and gruesome properties back-to-front. The real lesson of Goodman's riddle is that credences in hypotheses involving natural properties should be distinctively \textit{sensitive} to new evidence. Our evidence should make us quite confident that all emeralds are green, while giving us little reason to think that all emeralds are grue. What P2 says is that a rather natural hypothesis, that Rat is human, is \textit{insensitive} to all the evidence Rat has, while a rather gruesome hypothesis, that Rat is suman, is \textit{sensitive }to this evidence. The riddle of induction gives us no reason to believe that should happen.

It seems, though this is a little speculative, that the only reason for accepting P2 involves a simple fallacy. It is true that we have no reason to think that some evidence, say \textit{C}, is more or less likely given that Rat is human rather than a Sim. But from this we should \textit{not} conclude that we \textit{have }a reason to think it is not more or less likely given that Rat is human rather than a Sim, which is what P2 requires. Indeed, drawing this kind of conclusion will quickly lead to a contradiction, for we can use the same `reasoning' to conclude that we have a reason to think her evidence is not more or less likely given that Rat is a suman rather than a him.
...
%
%{\itshape
%\textup{BonJour, L. (1999) {\textquotedblleft}Foundationalism and the External World{\textquotedblright} }Philosophical Perspectives\textup{, 13, Epistemology, 1999. J. E. Tomberlin. Cambridge, Blackwell}}
%
%{\itshape
%\textup{Bostrom, N. (forthcoming) {\textquotedblleft}Are You Living in a Computer Simulation{\textquotedblright} }Philosophical Quarterly}
%
%{\itshape
%\textup{Elga, A. (2000) {\textquotedblleft}Self-Locating Belief and the Sleeping Beauty Problem.{\textquotedblright} }Analysis\textup{: 60(2) 143-7}}
%
%{\itshape
%\textup{Goodman, N. (1955) }Fact, Fiction and Forecast\textup{. Cambridge: Harvard University Press.}}
%
%{\itshape
%\textup{Keynes, J. M. (1921) }Treatise on Probability\textup{. London: Macmillan}}
%
%{\itshape
%\textup{Lewis, D. (1979) {\textquotedblleft}Attitudes }De Dicto\textup{ and }De Se\textup{.{\textquotedblright} }Philosophical Review\textup{: 88 513-43}}
%
%{\itshape
%\textup{Quine, W. V. O. (1973) }The Roots of Reference\textup{. La: Salle Il Open Court}}
%
%{\itshape
%\textup{Williamson, T. (2000) {\textquotedblleft}Scepticism and Evidence{\textquotedblright} }Philosophy and Phenomenological Research\textup{: 60(3) 613-28}}
%
