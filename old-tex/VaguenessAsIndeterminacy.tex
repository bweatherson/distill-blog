...
\pubdata{Richard Dietz and Sebastiano Moruzzi (eds.), \textit{Cuts and Clouds}, OUP, pp. 77-90. Thanks to David Chalmers, Matti Eklund, Delia Graff Fara, Patrick Greenough, Mark Johnston, Daniel Nolan, Nicholas J. J. Smith, Andrew Strauss and audiences at ANU, Princeton and Arch\'{e}.}
...
\subsection{Indeterminacy without Vagueness}
...
\item \begin{enumerate}
		\item Jack is very old.
		\item *Jack is very forty-seven years old.
	\end{enumerate}
}
...
\subsection{Philosophically Interesting Vague Terms}
...
\item
\begin{enumerate}
\item An academic with one child has few children.
\item If an academic with one child has few children, then an academic with two children has few children.
\item If an academic with two children has few children, then an academic with three children has few children.
\item If an academic with three children has few children, then an academic with four children has few children.
\item If an academic with four children has few children, then an academic with five children has few children.
\item So an academic with five children has few children.
\end{enumerate}
}
...
\subsection{Vagueness without Boundaries}
...
Matti \citet{Eklund2005} develops a similar kind of definition. He starts with Crispin Wright's \citeyearpar{Wright1975} famous definition of what it is for a predicate \textit{F} to be \textit{tolerant}.
...
\begin{quote}
Competent speakers are disposed to accept that whereas large enough differences in \textit{F}'s parameter of application sometimes matter to the justice with which it is applied, some small enough difference never thus matters.
\end{quote}

\noindent Here's the wide scope reading of this.

\begin{quote}
\textit{F}'s parameter of application is such that whereas competent speakers are disposed to accept that large enough differences in it sometimes matter to the justice with which \textit{F} is applied, some small enough difference never thus matters.
\end{quote}

\noindent And here is the narrow scope reading, with a phrase added for emphasis.

\begin{quote}
Competent speakers are disposed to accept that whereas large enough differences in \textit{F}'s parameter of application, \textit{whatever it is}, sometimes matter to the justice with which it is applied, some small enough difference never thus matters.
\end{quote}

\noindent To see the difference between the two cases, assume for the sake of argument that a competent speaker thinks that to be good is to do actions whose consequences have a high enough utility, whereas in reality to be good is to obey enough of God's commands. In each case \textit{being good} is vague, because we are using satisficing versions of consequentialism and divine command theory. So the parameter of application for \textit{being good} is the number of God's commands you obey. The competent speaker will not accept the wide scope version of tolerance with respect to \textit{being good}, because they don't think that large differences with respect to how many of God's commands you obey matter to the justice with which \textit{being good} is applied. Such cases can be multiplied endlessly to show that the wide scope version of Eklund's principle cannot generally be true, because it makes it the case that competent speakers have correct views on contentious philosophical matters the resolution of which goes beyond semantic competence. For these reasons Eklund has said (personal communication) that he intends the narrow scope version.
...
The definition also has trouble with \textit{tall}\textsubscript{179} for this satisfies Closeness vacuously. Though to be fair given the logical assumptions Smith makes, it is possible that no predicate with the properties I've associated with \textit{tall}\textsubscript{179} can be defined.
...
Let ${\tau}$ be a variable that ranges over truth states (e.g. true, determinately true, not determinately determinately not determinately true, etc.) \textit{v} a function from objects to real numbers such that whether \textit{x} is \textit{F} depends only on the value of \textit{v}(\textit{x}) (i.e. \textit{v} is \textit{F}'s parameter of application) and \textit{c} a suitably small number. Then \textit{F} is vague iff the following claim non-vacuously holds.
...
%References}
%
%Dorr, Cian 2003 ``Vagueness without Ignorance'' \textit{Philosophical Perspectives} vol. 17, pp. 83\nobreakdash-113.
%
%Eklund, Matti 2005 ``What Vagueness Consists in'' \textit{Philosophical Studies} vol. 125, no. 1, pp. 27-60.
%
%Field, Hartry 1973 ``Theory Change and the Indeterminacy of Reference'' \textit{Journal of Philosophy}
%
%vol. 70, no. 14, pp. 462-81.
%
%Fine, Kit 1975 ``Vagueness, Truth and Logic'' \textit{Synthese} vol. 30, nos. 3-4, pp. 265-300.
%
%Fara, Delia Graff 2000 ``Shifting Sands: An Interest-Relative Theory of Vagueness'' \textit{Philosophical Topics} vol. 28, no. 1, pp. 45\nobreakdash-81. [This paper was published under the name ``Delia Graff''.]
%
%Greenough, Patrick 2003 ``Vagueness: A Minimal Theory'' \textit{Mind} vol. 112, no. 446, pp. 235\nobreakdash-81.
%
%Horgan, Terrence 1995 ``Transvaluationism: a Dionysian Approach to Vagueness'' \textit{Southern Journal of Philosophy} vol. 33, Spindel Conference Supplement, pp. 97-125.
%
%Lewis, David 1986 \textit{On the Plurality of Worlds}, Blackwell, Oxford.
%
%Montague, Richard 1970 ``Universal grammar'' \textit{Theoria} vol. 36, no. 3, pp. 373-398. 
%
%Montague, Richard 1973 ``The Proper Treatment of Quantification in Ordinary English''. In  K.~J.~J. Hintikka, J. M. E. Moravcsik, and P. Suppes, (eds.) \textit{Approaches to Natural Language} Reidel, Dordrecht pp. 221-242. 
%
%Montague, Richard (1974). \textit{Formal Philosophy. Selected Papers of Richard Montague.} Edited and with an introduction by Richmond H. Thomason. New Haven/London: Yale University Press.
%
%Sainsbury, Mark 1991 ``Is There Higher-Order Vagueness?'' \textit{Philosophical Quarterly}, vol. 41, no. 163, pp.~167\nobreakdash-82.
%
%Smith, Nicholas J. J. 2005 ``Vagueness as Closeness'' \textit{Australasian Journal of Philosophy} vol. 83, no. 2, pp.~157\nobreakdash-83.
%
%Sorensen, Roy 2001 \textit{Vagueness and Contradiction}, Oxford University Press, Oxford.
%
%Weatherson, Brian 2005 ``True, Truer, Truest'' \textit{Philosophical Studies} vol. 123, nos. 1-2, pp. 47-70.
%
%Wolfe, Tom 2000 \textit{Hooking Up}, Farrar, Strauss and Giroux, New York.
%
%Wright, Crispin 1975 ``On the Coherence of Vague Predicates'' \textit{Synthese} vol. 30, nos. 3-4, pp. 325-65.
