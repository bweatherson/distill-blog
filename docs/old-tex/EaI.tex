...
\pubdata{\textit{Philosophy and Phenomenal Research} 70 (2005): 613-35. Thanks to Jamie Dreier, Adam Elga and an anonymous referee for helpful discussions about this paper and suggestions for improvements.}
...
Elga has an argument for INDIFFERENCE, which we shall get to by \textsection8, but for a while I will look at some immediate consequences of the position. I'll start with two reasons to think that INDIFFERENCE needs to be strengthened to play the role he wants it to play.
...
\section{It's Evidently Intransitive}
...
\section{Morgan and Morgan and Morgan and Morgan}
...
\noindent Assume (in all these cases) that before Al goes to sleep he knows the relevant facts of the case. In that case INDIFFERENCE\footnote{As with earlier cases, strictly speaking we need C\nobreakdash-INDIFFERENCE and P\nobreakdash-INDIFFERENCE to draw the conclusions suggested unless Al is somehow certain about all other propositions. I will ignore that complication here, and in \textsection9.} dictates that when Al wakes up his credence in \textit{I am Al} should be 0.5. Elga argues this dictate is appropriate by considering a pair of related cases.
...
%Bartha, Paul and Christopher Hitchcock (1999) ``The Shooting-Room Paradox and Conditionalizing on Measurably Challenged Sets'' \textit{Synthese} 118:~403\nobreakdash-37.

%Campbell, John (2002) \textit{Reference and Consciousness} Oxford: Oxford University Press.

%Chambers, Robert and John Quiggin (2000) \textit{Uncertainty, Production, Choice, And Agency: The State-Contingent Approach}. Cambridge: Cambridge University Press.

%Dreier, James (200x) ``Boundless Good'' ms.

%Elga, Adam (2000) ``Self-Locating Belief and the Sleeping Beauty Problem'' \textit{Analysis} 60:~143\nobreakdash-7.

%Elga, Adam (200x) ``Defeating Dr Evil with Self-Locating Belief'' \textit{Philosophy and Phenomenological Research} forthcoming.

%de Finetti, Bruno (1974) \textit{Theory of Probability}. New York: Wiley.

%Goodman, Nelson (1951) \textit{The Structure of Appearance} Cambridge, MA: Harvard University Press.

%Graff, Delia (2001) ``Phenomenal Continua and the Sorites'' \textit{Mind} 110: 905\nobreakdash-35.

%H\'{a}jek, Alan (forthcoming) ``Scotching Dutch Books'' paper presented at the 2002 Australasian Association for Philosophy conference, Christchurch, New Zealand, July 2002.

%Hetherington, Stephen (2001) \textit{Good Knowledge, Bad Knowledge: on two dogmas of epistemology}. Oxford: Oxford University Press.

%Jeffrey, Richard (1983) ``Bayesianism with a Human Face'' in John Earman (ed.) \textit{Testing Scientific Theories}, Minneapolis: University of Minnesota Press, pp.~133\nobreakdash-56.

%Keynes, John Maynard (1921) \textit{A Treatise on Probability} London: Macmillan.

%Keynes, John Maynard (1937) ``The General Theory of Employment'' \textit{Quarterly Journal of Economics} 51: 209\nobreakdash-223, reprinted in \textit{The General Theory and After: Part II Defence and Development}, vol XIV of \textit{The Collected Writings of John Maynard Keynes}, London: Macmillan, 1973, pp. 109-24, references to reprint.

%Knight, Frank (1921) \textit{Risk, Uncertainty and Profit}. Boston: Houghton Miffin.

%Kyburg, Henry (1974) \textit{The Logical Foundations of Statistical Inference}. Dordrecht: Reidel.

%Levi, Isaac (1974) ``On Indeterminate Probabilities'' \textit{Journal of Philosophy} 71: 391\nobreakdash-418.

%Levi, Isaac (1980) \textit{The Enterprise of Knowledge}. Cambridge, MA: MIT Press.

%Lewis, David (1970) ``How to Define Theoretical Terms'' \textit{Journal of Philosophy} 67:~427\nobreakdash-46.

%Lewis, David (1979) ``Attitudes \textit{De Dicto }and \textit{De Se}'' \textit{Philosophical Review} 88:~513\nobreakdash-43.

%McGee, Vann (1999) ``An Airtight Dutch Book'' \textit{Analysis} 59:~257\nobreakdash-65.

%Milne, Peter (1991) ``Scotching the Dutch Book Argument'' \textit{Erkenntnis} 32:~105\nobreakdash-26.

%Monton, Bradley (2002) ``Reflections on Sleeping Beauty'' \textit{Analysis} 62: 47\nobreakdash-53.

%Poole, David, Alan Mackworth and Randy Goebel (1998) \textit{Computational Intelligence: A Logical Approach}. Oxford: Oxford University Press.

%Ramsey, Frank (1926/1990) ``Truth and Probability'' in his \textit{Philosophical Papers }(D. H. Mellor, ed.) Cambridge: Cambridge University Press, pp. 52-94.

%Schick, Timothy (1986) ``Dutch Bookies and Money Pumps'' \textit{Journal of Philosophy} 83: 112-9.

%Shafer, Glenn (1978) \textit{A Mathematical Theory of Evidence}. Princeton: Princeton University Press.

%van Fraasen, Bas (1990) ``Figures in a Probability Landscape'' in M. Dunn and A. Gupta (eds.) \textit{Truth or Consequences}, Dordrecht: Kluwer, 1990, pp. 345-356.

%van Fraassen, Bas (1995) ``Belief and the Problem of Ulysses and the Sirens'' \textit{Philosophical Studies} 77:~7\nobreakdash-37.

%Williamson, Timothy (1998) ``Conditionalizing on Knowledge'' \textit{British Journal for the Philosophy of Science} 49:~89\nobreakdash-121.