...
%I've tidied this up a bit to clarify what the relevant background belief of Kate's is. I think the original draft suggested that what mattered was whether she had a belief that the generic *street signs around here are reliable* is true. But what I really meant for her to be focussing on was whether the very street signs she can see are correct, i.e., whether everything she can see on a street sign is true. If she has that belief, then her observational evidence entails she is on Main, so there is no need for further investigation. Of course, if she just has the generic belief, it is possible that the sign that says Main is one of the outliers, so there's no entailment that she's on Main. Thanks here to the referee for clearing this up.
